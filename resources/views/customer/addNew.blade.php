                        ...
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <form id="myForm" method="post" action="/customer" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="imagess">Customer Profile Image</label>
                                        <input type="file" class="form-control images" id="imagess" name="image" placeholder="Enter Customer's Image" accept="image/png, image/gif, image/jpeg, image/jpg, image/webp">
                                        <span class="text-danger">
                                            @error('image')
                                            {{ $message }}
                                            @enderror
                                        </span>
                                        <img class="previewing" id="previewing" src="#" alt="your image" height="100" width="100" style="display:none; margin: 10px;">
                                    </div>
